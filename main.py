...
def runGA4mTSP(dataPath=None, GA_type=globals.ALGO_DEFAULT, logr=None, maxNDC=globals.maxNDistCal):
...
if __name__ == '__main__':
    ...
    > Usage Example:
        python main.py -d instances/mtsp51.txt -ga baseline -so 1 -g 200 -p 100 -m 5 -dc 20000
    """
    ...
    # Run GA
    runGA4mTSP(dataPath=FLAGS.data, GA_type=FLAGS.ga, logr=logger, maxNDC=FLAGS.distCal)
